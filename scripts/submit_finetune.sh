...
#FineTune
echo srun --mpi=pmi2 shifter python train.py --fine_tune --data_folder /global/cfs/cdirs/m3246/vmikuni/H1v2/h5/ --closure --config config_Dec_lrscale5_patience10.json
srun --mpi=pmi2 shifter python train.py --fine_tune --data_folder /global/cfs/cdirs/m3246/vmikuni/H1v2/h5/ --closure --config config_Dec_lrscale5_patience10.json
